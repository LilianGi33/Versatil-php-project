<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        <p class="navbar-brand">
            <img scr="ASSETS/images/logofooter.png" />
</p>

<button class="navbar-toggler" type="button" data-toggle="colapse" data-target="#navbarContent">
...
<form class="d-flex m-auto mb-2" method="GET" action="home.php#listar">
    ...
    <button class="btn btn-sucess" type="sbmit">
        <i class="bi-search"></i>
</button>
</form>
