...
foreach ($capitalDao->buscarTodos() as $capital) {
    ...
    if ($capital['id'] == $c['capital_id']) {
        echo "<input checked class=\"form-check-input\" type=\"radio\" name=\"capital_id\"
        id=\"radioCapital-{$capital['id']}\" value\"{$capital['id']}\">";
    } else {
        echo "<input class=\"form-check-input\" type=\" name=\"capital_id\"
        id=\"radioCapital-{$capital['id']}\" value=\"{$capital['id']}\">";
    }
    echo "
 ...
 foreach($cargoDao->buscarTodos() as $cargo) {
    $descricao = utf8_encode($cargo[1descricao']);
